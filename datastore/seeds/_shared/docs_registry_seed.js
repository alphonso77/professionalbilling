/**
 * Shared docs_registry payload — required by both the production and
 * development seed runners. Lives outside `seeds/{env}` so Knex does not
 * try to run it as a top-level seed.
 */
